...
export class LeadNewPage {
  private static readonly L = {
    ...
    new: { strategy: 'css' as const, value: 'lightning-button[name="New"]', actionKind: 'button' as const },
    pipelineInspectionToListView: { strategy: 'css' as const, value: 'lightning-button[name="pipelineInspectionToListView"]', actionKind: 'button' as const },
    ...
    massChangeStatus: { strategy: 'css' as const, value: 'lightning-button[name="MassChangeStatus"]', actionKind: 'button' as const },
    massChangeOwner: { strategy: 'css' as const, value: 'lightning-button[name="MassChangeOwner"]', actionKind: 'button' as const },
    sendListEmailAction: { strategy: 'css' as const, value: 'lightning-button[name="SendListEmailAction"]', actionKind: 'button' as const },
    massAssignRecordLabel: { strategy: 'css' as const, value: 'lightning-button[name="MassAssignRecordLabel"]', actionKind: 'button' as const },
    ...
    cancelEdit: { strategy: 'css' as const, value: 'lightning-button[name="CancelEdit"]', actionKind: 'button' as const },
    saveAndNew: { strategy: 'css' as const, value: 'lightning-button[name="SaveAndNew"]', actionKind: 'button' as const },
    saveEdit: { strategy: 'css' as const, value: 'lightning-button[name="SaveEdit"]', actionKind: 'button' as const },
  } as const;
